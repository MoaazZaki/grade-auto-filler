...
def classify_symbol(symbol,  LINE_DISTANCE_THRESHOLD = 15,  LINE_ANGLE_THRESHOLD = 30,LINE_ANGLE_ALLOWANCE = 35,RECTANLE_BB_RATIO_ALLOWANCE = 0.4,TICK_MAX_AREA = 0.5,TICK_MIN_DISTANCE = 10,TICK_ANGLE_ALLOWANCE = 25):
  ...
  #_,thresh =  cv2.threshold(symbol, 150, 255,cv2.THRESH_BINARY_INV)
  ...
  elif vertical_angles == roi_cnts and rectangles == 0:
    return 'v_line',roi_cnts
  elif horizontal_angles == roi_cnts and rectangles == 0:
    return 'h_line',roi_cnts
  elif vertical_angles >= 2 and horizontal_angles >= 2 and roi_cnts == 1 and rectangles == 1:
    return 'rect',1
